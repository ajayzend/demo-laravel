...
class Visa extends Model
{
    ...
    protected $fillable = [
        ...
        'p4_booked_operator',
        'p4_name_tour_operator',
        'p4_address_tour_operator',
        'p4_name_tour_hotel',
        'p4_place_hotel',
        'p4_business_c_name',
        'p4_business_c_phone',
        'p4_business_c_website',
        'p4_business_f_name',
        'p4_business_f_phone',
        'p4_business_f_website',
        'p4_business_f_name_contact',
        'p4_medical_name',
        'p4_medical_id_flag',
        'p4_medical_id',
        'p4_medical_passport',
        'p4_medical_dob',
        'p4_medical_nationality',
