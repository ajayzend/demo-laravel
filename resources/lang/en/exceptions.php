...
return [
	...
	"visas" => [
	"already_exists" => "That Visa already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Visa. Please try again.",
	"delete_error" => "There was a problem deleting this Visa. Please try again.",
	"not_found" => "That Visa does not exist.",
	"update_error" => "There was a problem updating this Visa. Please try again.",
	],
	"ports" => [
	"already_exists" => "That Port already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Port. Please try again.",
	"delete_error" => "There was a problem deleting this Port. Please try again.",
	...
	"contactuses" => [
	"already_exists" => "That Contactus already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Contactus. Please try again.",
	"delete_error" => "There was a problem deleting this Contactus. Please try again.",
	"not_found" => "That Contactus does not exist.",
	"update_error" => "There was a problem updating this Contactus. Please try again.",
	],
	],
	"frontend" => [
	"auth" => [
