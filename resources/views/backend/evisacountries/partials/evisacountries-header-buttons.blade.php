<!--Action Button-->
@if( Active::checkUriPattern( 'admin/evisacountries' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.evisacountries.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.evisacountries.all' ) }}
            </a>
        </li>
        @permission( 'create-evisacountry' )
            <li>
                <a href="{{ route( 'admin.evisacountries.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.evisacountries.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
