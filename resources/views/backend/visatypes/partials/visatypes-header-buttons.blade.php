<!--Action Button-->
@if( Active::checkUriPattern( 'admin/visatypes' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.visatypes.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.visatypes.all' ) }}
            </a>
        </li>
        @permission( 'create-visatype' )
            <li>
                <a href="{{ route( 'admin.visatypes.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.visatypes.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
