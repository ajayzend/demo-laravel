<!--Action Button-->
@if( Active::checkUriPattern( 'admin/occupations' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.occupations.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.occupations.all' ) }}
            </a>
        </li>
        @permission( 'create-occupation' )
            <li>
                <a href="{{ route( 'admin.occupations.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.occupations.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
