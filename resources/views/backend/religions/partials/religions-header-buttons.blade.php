<!--Action Button-->
@if( Active::checkUriPattern( 'admin/religions' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.religions.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.religions.all' ) }}
            </a>
        </li>
        @permission( 'create-religion' )
            <li>
                <a href="{{ route( 'admin.religions.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.religions.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
