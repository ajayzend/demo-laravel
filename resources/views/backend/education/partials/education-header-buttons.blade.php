<!--Action Button-->
@if( Active::checkUriPattern( 'admin/education' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.education.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.education.all' ) }}
            </a>
        </li>
        @permission( 'create-education' )
            <li>
                <a href="{{ route( 'admin.education.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.education.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
