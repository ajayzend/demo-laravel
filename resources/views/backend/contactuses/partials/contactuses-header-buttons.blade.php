<!--Action Button-->
@if( Active::checkUriPattern( 'admin/contactuses' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.contactuses.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.contactuses.all' ) }}
            </a>
        </li>
        @permission( 'create-contactus' )
            <li>
                <a href="{{ route( 'admin.contactuses.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.contactuses.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
