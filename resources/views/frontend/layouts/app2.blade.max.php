    ...
    $(document).ready(function(){
        ...
        app3.validate({
            rules:{
                ...
                p3_other_occupation          		            :		{ required : true},
                p3_occupation_hw          		                :		{ required : true,  selected : true},
            ...
            messages:{
                ...
                p3_other_occupation                             :	    { required : "Please enter Other Occupation" },
                p3_occupation_hw                             	:	    { required : "This field is required", selected : "Please select occupation details" },
