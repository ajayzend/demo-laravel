    ...
    <tr>
        <td>
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="655" style=" border-spacing: 0;margin:0 auto;background:#fff;">
                ...
                <tr>
                    <td>
                        <p style="margin-top:20px;padding:0px 20px;">To complete your application kindly open {{config('app.url')}}visa-payment-process and enter your temporary application-id {{ session()->get('evpuid') }}</p>
                    </td>
                </tr>
                <tr>
                    <td>
